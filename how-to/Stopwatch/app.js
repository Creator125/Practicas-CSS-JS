...
//Evento para el botón de iniciar cronometro
...
//Función para iniciar contadores del cronometro
...
//Evento para el botón de pausar cronometro
document.getElementById("pause-timer").addEventListener("click", () => {
    clearInterval(int);
});

//Evento para el botón de reiniciar cronometro
